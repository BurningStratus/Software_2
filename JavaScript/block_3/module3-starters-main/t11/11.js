...
const sectionTarget = document.getElementById('pictures');

for (let pic = 0; pic < picArray.length; pic++) {
  const newArticle = createArticle(picArray[pic]);
  sectionTarget.append(newArticle);
}
console.log('\ndone')