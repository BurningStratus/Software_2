...
If you enter Anna as the name, for example, the 
...
schools = ['Gryffindor', 'Slytherin', 'Hufflepuff', 'Ravenclaw'];

const magic_hat = Math.floor(Math.random() * 4);
school = schools[magic_hat];

document.querySelector('#target0').innerHTML = `${username}, you are ${school}.`;
